...
def train():
    ...
    for e in range(n_episodes): # iterate over new episodes of the game
        ...
        for time in range(300):  # time represents a frame of the game; goal is to keep pole upright as long as possible up to range, e.g., 500 or 5000 timesteps
        #         env.render()
            ...
            if done: # episode ends if agent drops pole or we reach timestep 5000
                print("episode: {}/{}, score: {}, e: {:.2}, time: {}" # print the episode's score and agent's epsilon
