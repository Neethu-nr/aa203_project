...
lb(7*N+8:end) = -muMax; ub(7*N+8:end) = muMax; % For the state y : 0\le x \le l

options=optimoptions('fmincon','Display','iter','Algorithm','sqp','MaxFunctionEvaluations',30000,'ConstraintTolerance',1e-2,'OptimalityTolerance',1e-2);
